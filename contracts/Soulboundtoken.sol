...
contract HackerHouseSBT is ERC721 {
    ...
    function mint(
        ...
        require(
            ...
            "This address already has an SBT"
        );
        _tokenIdCounter++;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        bytes memory json = abi.encodePacked(
            '{"name": "',
            data.name,
            '", "description": "University Soulbound Token", ',
            '"attributes": [',
            '{"trait_type": "Specialty", "value": "',
            data.specialty,
            '"},',
    ...
    function _beforeTokenTransfer(
        ...
        require(from == address(0), "SBT is not transferable");
        super._beforeTokenTransfer(from, to, tokenId);
    }
}